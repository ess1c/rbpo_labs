...
public class ListingController {
    ...
    public ResponseEntity<?> createListing(@RequestBody Listing listing) {
        ...
        if (listing.getCategory() == null || listing.getCategory().getId() == null) {
        ...
        listing.setUser(userRepository.findById(listing.getUser().getId()).orElse(null));
        listing.setCategory(categoryRepository.findById(listing.getCategory().getId()).orElse(null));
